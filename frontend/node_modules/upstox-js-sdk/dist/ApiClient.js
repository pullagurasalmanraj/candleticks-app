...
class ApiClient {
  constructor(sandbox = false) {
    ...
    this.sandboxUrls = new Set(["/v2/order/place", "/v2/order/modify", "/v2/order/cancel", "/v2/order/multi/place", "/v3/order/place", "/v3/order/modify", "/v3/order/cancel"]);
    if (this.sandbox) {
