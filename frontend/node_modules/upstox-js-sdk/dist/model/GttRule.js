...
class GttRule {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new GttRule();
      if (data.hasOwnProperty('strategy')) obj.strategy = _ApiClient.ApiClient.convertToType(data['strategy'], 'String');
      if (data.hasOwnProperty('trigger_type')) obj.triggerType = _ApiClient.ApiClient.convertToType(data['trigger_type'], 'String');
      if (data.hasOwnProperty('trigger_price')) obj.triggerPrice = _ApiClient.ApiClient.convertToType(data['trigger_price'], 'Number');
      if (data.hasOwnProperty('trailing_gap')) obj.trailingGap = _ApiClient.ApiClient.convertToType(data['trailing_gap'], 'Number');
    }
    return obj;
  }
}
