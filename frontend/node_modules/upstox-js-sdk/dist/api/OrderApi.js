...
class OrderApi {
  ...
  */
  ...
  cancelMultiOrder(opts, callback, algoId) {
    ...
    let returnType = _CancelOrExitMultiOrderResponse.CancelOrExitMultiOrderResponse;
    return this.apiClient.callApi('/v2/order/multi/cancel', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  ...
  cancelOrder(orderId, apiVersion, callback, algoId) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _CancelOrderResponse.CancelOrderResponse;
    return this.apiClient.callApi('/v2/order/cancel', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
       * Exit all positions
  ...
  exitPositions(opts, callback, algoId) {
    ...
    let accepts = ['application/json', '*/*'];
    let returnType = _CancelOrExitMultiOrderResponse.CancelOrExitMultiOrderResponse;
    return this.apiClient.callApi('/v2/order/positions/exit', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getOrderBook(apiVersion, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*', 'application/json'];
    let returnType = _GetOrderBookResponse.GetOrderBookResponse;
    return this.apiClient.callApi('/v2/order/retrieve-all', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getOrderDetails(apiVersion, opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetOrderResponse.GetOrderResponse;
    return this.apiClient.callApi('/v2/order/history', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getOrderStatus(opts, callback) {
    ...
    let contentTypes = [];
    let accepts = ['application/json', '*/*'];
    let returnType = _GetOrderDetailsResponse.GetOrderDetailsResponse;
    return this.apiClient.callApi('/v2/order/details', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getTradeHistory(apiVersion, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*', 'application/json'];
    let returnType = _GetTradeResponse.GetTradeResponse;
    return this.apiClient.callApi('/v2/order/trades/get-trades-for-day', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getTradesByOrder(orderId, apiVersion, callback) {
    ...
    let accepts = ['application/json', '*/*'];
    let returnType = _GetTradeResponse.GetTradeResponse;
    return this.apiClient.callApi('/v2/order/trades', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  placeMultiOrder(body, callback, algoId) {
    ...
    let accepts = ['*/*', 'application/json'];
    let returnType = _MultiOrderResponse.MultiOrderResponse;
    return this.apiClient.callApi('/v2/order/multi/place', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  ...
  modifyOrder(body, apiVersion, callback, algoId) {
    ...
    let contentTypes = ['application/json'];
    let accepts = ['application/json', '*/*'];
    let returnType = _ModifyOrderResponse.ModifyOrderResponse;
    return this.apiClient.callApi('/v2/order/modify', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  placeOrder(body, apiVersion, callback, algoId) {
    ...
    let contentTypes = ['application/json'];
    let accepts = ['*/*', 'application/json'];
    let returnType = _PlaceOrderResponse.PlaceOrderResponse;
    return this.apiClient.callApi('/v2/order/place', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
