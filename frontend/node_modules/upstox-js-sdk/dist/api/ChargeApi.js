...
var _MarginRequest = _interopRequireDefault(require("../model/MarginRequest"));
...
class ChargeApi {
  ...
  */
  ...
  getBrokerage(instrumentToken, quantity, product, transactionType, price, apiVersion, callback) {
    ...
    let returnType = _GetBrokerageResponse.GetBrokerageResponse;
    return this.apiClient.callApi('/v2/charges/brokerage', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  postMargin(body, callback) {
    ...
    let accepts = ['application/json', '*/*'];
    let returnType = _PostMarginResponse.PostMarginResponse;
    return this.apiClient.callApi('/v2/charges/margin', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
exports.ChargeApi = ChargeApi;