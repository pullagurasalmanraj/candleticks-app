...
class LoginApi {
  ...
  */
  ...
  authorize(clientId, redirectUri, apiVersion, opts, callback) {
    ...
    let returnType = null;
    return this.apiClient.callApi('/v2/login/authorization/dialog', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  mapToInitTokenRequestForIndieUser(data) {
    let obj = {};
    if (data) {
      if (data.hasOwnProperty('clientSecret')) obj.client_secret = _ApiClient.ApiClient.convertToType(data['clientSecret'], 'String');
    }
    return obj;
  }
  /**
  ...
  initTokenRequestForIndieUser(body, clientId, callback) {
    ...
    let accepts = ['application/json', '*/*'];
    let returnType = _IndieUserInitTokenResponse.IndieUserInitTokenResponse;
    return this.apiClient.callApi('/v3/login/auth/token/request/{client_id}', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  logout(apiVersion, callback) {
    ...
    let contentTypes = [];
    let accepts = ['*/*', 'application/json'];
    let returnType = _LogoutResponse.LogoutResponse;
    return this.apiClient.callApi('/v2/logout', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  token(apiVersion, opts, callback) {
    ...
    let accepts = ['application/json', '*/*'];
    let returnType = _TokenResponse.TokenResponse;
    return this.apiClient.callApi('/v2/login/authorization/token', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
