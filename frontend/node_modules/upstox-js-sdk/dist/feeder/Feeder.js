 ...
 */
class Feeder extends _stream.Readable {
  constructor() {
    super();
    if (new.target === Feeder) {
      throw new Error("Feeder is an interface-like class and cannot be instantiated directly.");
    }
  }
...
var _default = exports.default = Feeder;